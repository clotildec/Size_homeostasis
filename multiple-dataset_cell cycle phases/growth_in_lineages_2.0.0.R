...
## parameters to enter ####
dir=("C:/Users/Clotilde/Desktop/analysis_150630/")
title="150605_HT29_sylvain_analysis_150630_ds0"
...
xlab=" "
for (i in cond){
  xlab=paste(xlab,"\n",i,": mean=",signif(mean(df$vf[which(df$sort_cond==i & is.na(df$vf)==F)]),a), ", n=",length(df$vf[which(df$sort_cond==i & is.na(df$vf)==F)]),sep="")
}
hist3 <- ggplot(df,aes(x=vf,fill=as.factor(sort_cond)))+
  geom_histogram(position="dodge")+
  theme_bw()+
  labs(title=title,
       fill="cond",
...
xlab=" "
for (i in cond){
  xlab=paste(xlab,"\n",i,": mean=",signif(mean(df$vi[which(df$sort_cond==i & is.na(df$vi)==F)]),a), ", n=",length(df$vi[which(df$sort_cond==i & is.na(df$vi)==F)]),sep="")
}
hist4 <- ggplot(df,aes(x=vi,fill=as.factor(sort_cond)))+
  geom_histogram(position="dodge")+
  theme_bw()+
  labs(title=title,
       fill="generation",
...
xlab=" "
for (i in cond){
  xlab=paste(xlab,"\n",i,": mean=",signif(mean(df$dv[which(df$sort_cond==i & is.na(df$dv)==F)]),a), ", n=",length(df$dv[which(df$sort_cond==i & is.na(df$dv)==F)]),sep="")
}
hist5 <- ggplot(df,aes(x=dv,fill=as.factor(sort_cond)))+
  geom_histogram(position="dodge")+
  theme_bw()+
  labs(title=title,
       fill="cond",
...
xlab=" "
for (i in cond){
  xlab=paste(xlab,"\n",i,": mean=",signif(mean(df$dvdt[which(df$sort_cond==i & is.na(df$dvdt)==F)]),a), ", n=",length(df$dvdt[which(df$sort_cond==i & is.na(df$dvdt)==F)]),sep="")
}
hist6 <- ggplot(df,aes(x=dvdt,fill=as.factor(sort_cond)))+
  geom_histogram(position="dodge")+
  theme_bw()+
  labs(title=title,
       fill="cond",
...
xlab=" "
for (i in cond){
  xlab=paste(xlab,"\n",i,": mean=",signif(mean(df$dt[which(df$sort_cond==i & is.na(df$dt)==F)]),a), ", n=",length(df$dt[which(df$sort_cond==i & is.na(df$dt)==F)]),sep="")
}
hist7 <- ggplot(df,aes(x=dt,fill=as.factor(sort_cond)))+
  geom_histogram(position="dodge")+
  theme_bw()+
  labs(title=title,
       fill="cond",
...
write.csv(df,paste(dir,title,"_ctrl_vol_df.csv"))
...
#### choose parameters for analysis ####
tri = df$cond_date # column in dataframe with the sorting variable
K= which(colnames(df)=="cond_date") # number of the column with the sorting variable
name_tri = 'date' # title of the sorting variable
